...
export default function DashboardScreen() {
    ...
    useEffect(() => {
        ...
        fetch("http://203.154.68.166:9900/get-field", {
            method: "POST",
        ...
        fetch("http://203.154.68.166:9900/get-data", {
            method: "POST",
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify({})
        })
    ...
    const createField = () => {
        ...
        fetch("http://203.154.68.166:9900/create-field", {
            method: "POST",
            headers: { "Content-Type": "application/json" },
    ...
    const createData = () => {
        ...
        fetch("http://203.154.68.166:9900/create-data", {
            method: "POST",
            headers: { "Content-Type": "application/json" },
            ...
            .then(json => {
                if (json.status) {
                    ...
                    return fetch("http://203.154.68.166:9900/get-data", {
                        method: "POST",
                        headers: { "Content-Type": "application/json" },
                        body: JSON.stringify({}),
                    });
